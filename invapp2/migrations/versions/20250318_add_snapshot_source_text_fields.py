"""Add source text fields to inventory snapshot lines.

Revision ID: 20250318_add_snapshot_source_text_fields
...
revision = "20250318_add_snapshot_source_text_fields"
