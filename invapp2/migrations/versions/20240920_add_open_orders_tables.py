...
Revision ID: 20240920_add_open_orders_tables
...
revision = "20240920_add_open_orders_tables"
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["uploaded_by_user_id"],
            ["user.id"],
            name="fk_open_order_upload_user",
            ondelete="SET NULL",
        ),
    )
    ...
    op.create_table(
        ...
        sa.Column("so_state", sa.String(length=32), nullable=True),
        ...
        sa.Column("system_state", sa.String(length=32), nullable=False, server_default="NEW"),
        ...
        sa.Column("internal_status", sa.String(length=32), nullable=False, server_default="UNREVIEWED"),
        ...
        sa.ForeignKeyConstraint(
            ...
            name="fk_open_order_line_first_upload",
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["last_seen_upload_id"],
            ["open_order_upload.id"],
            name="fk_open_order_line_last_upload",
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["completed_upload_id"],
            ["open_order_upload.id"],
            name="fk_open_order_line_completed_upload",
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["owner_user_id"],
            ["user.id"],
            name="fk_open_order_line_owner",
            ondelete="SET NULL",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["upload_id"],
            ["open_order_upload.id"],
            name="fk_open_order_snapshot_upload",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["line_id"],
            ["open_order_line.id"],
            name="fk_open_order_snapshot_line",
            ondelete="CASCADE",
        ),
    )
