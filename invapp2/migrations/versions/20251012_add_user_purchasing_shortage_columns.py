...
Revision ID: 20251012_add_user_purchasing_shortage_columns
...
revision = "20251012_add_user_purchasing_shortage_columns"
...
def upgrade() -> None:
    op.add_column("user", sa.Column("purchasing_shortage_columns", sa.JSON(), nullable=True))
